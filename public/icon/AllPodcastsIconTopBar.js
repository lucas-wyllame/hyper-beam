...
export function AllPodcastsIconTopBar(props) {
  return (
    <svg
      ...
      <g id="Grupo_314" data-name="Grupo 314" transform="translate(3 1)">
        ...
        <g transform="matrix(1, 0, 0, 1, -3, -1)" filter="url(#Caminho_155)">
          <path
            ...
            d="M12,12,3,12a9,9,0,1,0,9-9,9,9,0,0,0-9,9"
            transform="translate(3 1)"
            fill="none"
            stroke="#ffe747"
        ...
        <g transform="matrix(1, 0, 0, 1, -3, -1)" filter="url(#Caminho_156)">
          <path
            ...
            d="M8,11.973a6.838,6.838,0,0,1,7.5.527"
            transform="translate(3 1)"
            fill="none"
            stroke="#ffe747"
            stroke-linecap="round"
        ...
        <g transform="matrix(1, 0, 0, 1, -3, -1)" filter="url(#Caminho_158)">
          <path
            ...
            d="M7,9a10.249,10.249,0,0,1,10,.5"
            transform="translate(3 1)"
            fill="none"
            stroke="#ffe747"
            stroke-linecap="round"
